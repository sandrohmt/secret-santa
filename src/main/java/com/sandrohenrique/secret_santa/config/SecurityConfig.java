...
public class SecurityConfig {
    ...
    public JwtDecoder jwtDecoder() {
        return NimbusJwtDecoder.withPublicKey(publicKey).build(); // Decoder a partir da chave pública, é quem vai fazer a descriptografia do JWT quando ele receber a cifra na requisição
    }
